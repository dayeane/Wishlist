    ...
    return(
        <div className="container">   
            <div className="row justify-content-center" style={{fontFamily:"dosis"}}>
                ...
                <br></br>
                <p>We pride ourselves with how easy it is to get started on creating, adding, updating and deleting products and lists with just a few key strokes. The user should be able to login 
